  ...
  return (
    <div>
        ...
        <div className='flex flex-col md:flex-row my-10 justify-center gap-10 mb-28 text-sm'>
          ...
          <div className='flex flex-col justify-center items-start text-gray-600 gap-6'>
            ...
            <button className='border border-gray-700 px-8 py-4 text-gray-800 hover:bg-gray-800 hover:text-white transition-all duration-300'>Explore Jobs</button>
          </div>
        </div>
    </div>
  )
